...
[🚀 Live Demo](https://task-manager-api-slip.vercel.app) • [📖 API Docs](https://taskmanagerapi-production-8a33.up.railway.app/docs) • [🐛 Report Bug](https://github.com/Annu881/Task_manager_api/issues)
...
|---------|----------|-----|--------|
| **Frontend** | Vercel | [task-manager-api-slip.vercel.app](https://task-manager-api-slip.vercel.app) | ![Status](https://img.shields.io/badge/status-live-success) |
