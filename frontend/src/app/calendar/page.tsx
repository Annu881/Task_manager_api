              ...
              return (
                ...
                >
                  <div className={`text-sm font-medium mb-1 ${
                    isToday ? 'text-purple-600 dark:text-purple-400' : 'text-slate-700 dark:text-slate-300'
                  }`}>
                    {format(day, 'd')}
                  </div>
                  <div className="space-y-1">
                    {tasksForDay.slice(0, 3).map(task => (
                      <div
                        key={task.id}
                        className="text-xs p-1 rounded bg-purple-500/20 text-purple-700 dark:text-purple-300 truncate cursor-pointer hover:bg-purple-500/30"
